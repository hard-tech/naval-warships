  ...
  return (
    <div>
      ...
      <center>
        <h1>Score board</h1>
        <table
          className="bg-white text-dark border border-dark border-3"
          width={800}
        >
        ...
        <h2 className="p-5 my-5">
          {CounterJ1 === 20
            ? `Bravo ${Player1} tu à planter les 20 drapeaux avant ${Player2} !`
            : `Bravo ${Player2} tu à planter les 20 drapeaux avant ${Player1} !`}
        </h2>
      </center>
      <Footer />
    </div>
